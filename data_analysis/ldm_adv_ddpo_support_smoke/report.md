...
## Conclusion
- ddpo_feasibility: `weak_base_support`
- base high-reward sample rate=0.0000
- base scene coverage with any high sample=0.0000
- artifact among high reward=nan
- init-invalid mean=0.0000
- small-vehicle mean=0.0000

## Split Summary
### train/base
- n_samples: `1`
- high_reward_sample_rate: `0.000000`
- positive_sample_rate: `0.000000`
- reward_p95 / p99 / max: `-1.0000` / `-1.0000` / `-1.0000`
- scene_with_high_reward_sample_rate: `0.000000`
- near_miss_rate_mean: `0.000000`
- collision_rate_mean: `0.000000`
- init_invalid_rate_mean: `0.000000`
- goal_offlane_rate_mean: `1.000000`
- controlled_parking_rate_mean: `1.000000`
- small_vehicle_rate_mean: `0.000000`
...
save_every: 100
resume: true
output_dir: data/critical_scene/critical_scene_ddpo_ldm_adv_ddim_bad_driver
ddpo:
  estimator: is
  clip_range: 0.0001
  kl_coef: 0.2
...
wandb:
  ...
  entity: null
  run_name: critical_scene_ddpo_ldm_adv_ddim_bad_driver
eval_every: 50
eval_num_scenes: 8
